...
Proxy = {
  Proxy: (function() {
    ...
    _Class.prototype.message_received = function(event) {
      if (event.origin !== this.expected_domain) return;
  ...
  ImageLoader: (function() {
    ...
    _Class.prototype.execute = function(message) {
      switch (message.action) {
        case 'load':
          return this.load_image(message.path, message.id);
      }
    };

    _Class.prototype.load_image = function(path, id) {
      var image;
